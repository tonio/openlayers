...
OpenLayers.Control.LayerSwitcher = 
  ...
  // DOM Elements
    ...
    loadContents: function() {
        ...
        // maximize button div
        this.maximizeDiv = document.createElement('a');
        this.maximizeDiv.id = "OpenLayers_Control_MaximizeDiv";
        this.maximizeDiv.innerHTML = "+";
        this.maximizeDiv.href = '#';
        ...
        // minimize button div
        this.minimizeDiv = document.createElement('a');
        this.minimizeDiv.id = "OpenLayers_Control_MinimizeDiv";
        this.minimizeDiv.innerHTML = "-";
        this.minimizeDiv.href = '#';
